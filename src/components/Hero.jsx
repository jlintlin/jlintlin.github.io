      ...
      <div className="max-w-5xl mx-auto text-center relative z-10">
        ...
        <div className="grid md:grid-cols-3 gap-4 mb-12">
          {roles.map((role, index) => {
            ...
            return (
              ...
              >
                <div className={`w-12 h-12 bg-gradient-to-br ${role.color} rounded-xl flex items-center justify-center text-white mb-3 mx-auto`}>
        ...
        >
          <p className="text-theme-secondary leading-relaxed">
            Computer Science researcher and educator, interested in AI security, full-stack systems,
            and quantitative modeling. Always learning, always curious.
          </p>
        </motion.div>
      </div>
    </section>
