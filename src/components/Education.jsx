                ...
                <div className="md:ml-20 glass rounded-2xl p-6 hover:glass-strong transition-all duration-300 hover:scale-[1.02] hover:-translate-y-1">
                  <div className="flex flex-col gap-4">
                    <div className="flex-1">
                      <div
                        className={`inline-block bg-gradient-to-r ${edu.color} text-white px-4 py-1.5 rounded-full text-sm mb-3`}
                      >
                        {edu.period}
                      </div>
                  ...
                  {edu.minor && (
                    <div className="mt-4 pt-4 border-t border-glass-border text-theme-secondary">Minor: {edu.minor}</div>
                  )}
                </div>
              </motion.div>
            ))}
